  ...
  if (activeMenu === "clinic") {
    return (
      <>
        ...
        >
          <div
            className="h-[14px] w-full rounded-t-[20px] bg-[#F5A200]"
            aria-hidden="true"
          />
          ...
          <div className="mt-3 flex items-start justify-between gap-3">
            <div className="flex items-start gap-3">
              <span
                className="mt-1 h-10 w-[5px] rounded-full bg-[#F5A200]"
                aria-hidden="true"
              />
            ...
            <button
              ...
              className="shrink-0 rounded-lg bg-[#F5A200] px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-[#E09700]"
            >
              ＋ 新規登録
            </button>
          </div>
