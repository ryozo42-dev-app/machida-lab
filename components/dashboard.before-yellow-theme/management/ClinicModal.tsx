  ...
  return (
    ...
    >
      <div className="w-full max-w-[520px] overflow-hidden rounded-[20px] border border-[#E6E6E6] bg-white shadow-xl">
        <div className="h-[10px] bg-[#F5A200]" />
          ...
          <div className="mt-6 space-y-5">
            <label className="block">
              ...
              <input
                ...
                className="mt-2 w-full rounded-lg border border-[#DCDCDC] bg-white px-3 py-2.5 text-sm text-[#222222] outline-none transition-colors placeholder:text-[#AAAAAA] focus:border-[#F5A200]"
              />
            </label>
